...
class Declicsweb_Slide_Admin {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/declicsweb-slide-admin' . $this->script_suffix . '.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/declicsweb-slide-admin' . $this->script_suffix . '.js', array( 'jquery' ), $this->version, false );
		wp_enqueue_media();
	}
