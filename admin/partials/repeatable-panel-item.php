...
<tr class="panel <?php echo ( $hidden_panel ? 'hidden' : '' ); ?>">
	...
	<td class="width-65 no-padding">
		...
		<div class="otb-tabs-container">
			<ul class="tabs">
				<li><a data-tab="content" class="active"><?php esc_html_e( 'Content', $this->namePot ); ?></a></li>
				<li><a data-tab="seo"><?php esc_html_e( 'SEO', $this->namePot ); ?></a></li>
				<li><a data-tab="styling"><?php esc_html_e( 'Styling', $this->namePot ); ?></a></li>
			</ul>
			...
			<div class="tab-content content active">
				...
				<ul class="buttons sortable">
					...
					<li class="footer alignright">
						<a class="button add-button <?php echo ( $active_button_count == $max_buttons ) ? 'disabled' : ''; ?>" href="#"><?php esc_html_e( 'Add a Button', $this->namePot ); ?></a>
					</li>
				</ul>
			</div>
