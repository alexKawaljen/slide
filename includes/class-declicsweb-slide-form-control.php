 ...
 */
class Declicsweb_Slide_Form_Control {
		...
		switch( $this->type ) {
			...
			case 'media_upload':
				...
				if ( $has_image ) {
					...
					$html .= '<img src="" />';
					//$html .= '<p class="hide-if-no-js"><a title="' . esc_attr__( 'Upload Image', $this->namePot ) . '" href="javascript:;" id="upload_header_image_button" class="button upload" data-uploader_title="' . esc_attr__( 'Upload Image', $this->namePot ) . '" data-uploader_button_text="' . esc_attr__( 'Upload Image', $this->namePot ) . '">' . esc_html__( 'Upload Image', $this->namePot ) . '</a></p>';
