...
class Slider_plugin {
	 ...
	 */
	public function __construct( $file = '', $version = DECLICSWEB_SLIDE_VERSION ) {
		$this->_version = $version;
		$this->_text_domain	= 'declicsweb-slide';
		$this->_token   = 'declicsweb_slide';

		// Load plugin environment variables.
		$this->file       = $file;
		$this->dir        = dirname( $this->file );
		$this->assets_dir = trailingslashit( $this->dir ) . 'includes';
		$this->assets_url = esc_url( trailingslashit( plugins_url( '/includes/', $this->file ) ) );
	 ...
	 *
	 * @return bool|string|Declicsweb_Slide_Post_Type
	 */
	public function register_post_type( $post_type = '', $plural = '', $single = '', $description = '', $options = array() ) {
		...
		$post_type = new Declicsweb_Slide_Post_Type( super_simple_slider(), $post_type, $plural, $single, $description, $options );
	...
	public function load_localisation() {
		load_plugin_textdomain( 'declicsweb-slide', false, dirname( plugin_basename( $this->file ) ) . '/languages/' );
	}
	 ...
	 * @static
	 */
	public static function instance( $file = '', $version = DECLICSWEB_SLIDE_VERSION ) {
	...
	public function __clone() {
		_doing_it_wrong( __FUNCTION__, esc_html( __( 'Cloning of Declicsweb slide is forbidden' ) ), esc_attr( $this->_version ) );
	}
	...
	public function __wakeup() {
		_doing_it_wrong( __FUNCTION__, esc_html( __( 'Unserializing instances of Declicsweb slide is forbidden' ) ), esc_attr( $this->_version ) );
	}
